...
export type CreateSchemaInferencerConfig = {
    /**
...
export type SchemaInferencerResultComponent = React.FC<InferencerComponentProps>;

export type CreateSchemaInferencer = (
    config: CreateSchemaInferencerConfig,
